...
const markdownComponents: Components = {
  pre({ children }) {
    ...
    return (
      <CodeBlock
        code={getCodeText(node, codeChildren)}
        language={resolveBlockLanguage(className)}
      />
    )
  },

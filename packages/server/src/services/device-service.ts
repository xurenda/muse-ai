...
import type { Device, DeviceCredentialsResponse, DeviceHeartbeatRequest, DevicePairRequest, DevicePairResponse, PairInitResponse } from '@museai/shared'
import { deviceCredentialsResponseSchema, deviceSchema } from '@museai/shared'

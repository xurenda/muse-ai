...
- `pnpm --filter @museai/shared build` — 通过
- `pnpm --filter @museai/web test:run` — **27 passed**（含 `cli-client-sse`、`connection-errors`、`device-aggregate-status`）
...
- `pnpm --filter @museai/cli build` — 通过
...
- `pnpm --filter @museai/shared build` — 通过
- `pnpm --filter @museai/core build` — 通过
- `pnpm --filter @museai/cli build` — 通过
...
- [x] `pnpm --filter @museai/shared build`
- [x] `pnpm test:run` — **45** 文件 / **174** 测试通过
- [x] `pnpm --filter @museai/web typecheck`
- [x] `pnpm --filter @museai/web build`（有 chunk >500kB 警告，非失败）
...
- `pnpm --filter @museai/web typecheck` — 通过
- `pnpm --filter @museai/web build` — 通过（chunk >500kB 警告，非失败）
